        ...
        <div class="row mt-4">
            <div class="col-md-6 mb-3">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <a href="admin_create_post.php" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i> Create New Post</a>
            ...
            <div class="col-md-6 mb-3">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <a href="admin_create_event.php" class="btn btn-primary btn-sm"><i class="bi bi-calendar-event"></i> Create New Event</a>
