...
<div style="background: #ededed; border-bottom: 2px solid #ccc;">
    <div class="container-fluid">
        <ul class="nav justify-content-center" style="gap:2.5rem; padding:0.5rem 0;">
            <li class="nav-item">
                <a class="nav-link" href="agent_home.php" style="color:#222;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="agent_tickets.php" style="color:#222;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="agent_quotations.php" style="color:#222;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="agent_profile.php" style="color:#222;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="agent_products.php" style="color:#222;">
